...
/*
 * This file contains the interface to the DTV service.
 *
 * Two functions are provided: |register_dtv| and |unregister_dtv|
 * for registering and unregistering the service in the protocol framework.
 *
 * For registering, |register_dtv| takes a callback for sending PDUs
 * and returns DTV's service-handler function on success. On errors,
 * NULL is retured.
 *
 * After the register function returns successfully, DTV will be able to
